...
QT_MOC_LITERAL(3, 23, 9)
    ...
    "Drone\0signalFromDrone\0\0updateAge\0"
};
...
void Drone::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->signalFromDrone(); break;
        ...
        {
            typedef void (Drone::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Drone::signalFromDrone)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Drone::staticMetaObject = {
    { &Bee::staticMetaObject, qt_meta_stringdata_Drone.data,
...
void *Drone::qt_metacast(const char *_clname)
{
    ...
    return Bee::qt_metacast(_clname);
}

int Drone::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = Bee::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
